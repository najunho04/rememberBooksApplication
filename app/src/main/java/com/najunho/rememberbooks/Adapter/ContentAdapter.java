...
public class ContentAdapter extends RecyclerView.Adapter<ContentAdapter.ContentViewHolder> {
    ...
    public ContentAdapter(FragmentActivity fragmentActivity, onSelectedFragmentListener listener) {
    ...
    public ContentViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new ContentViewHolder(view, fragmentActivity, listener);
    }
    ...
    static class ContentViewHolder extends RecyclerView.ViewHolder {
        ...
        public ContentViewHolder(@NonNull View itemView, FragmentActivity fragmentActivity,onSelectedFragmentListener listener) {
            super(itemView);
            viewPager = itemView.findViewById(R.id.viewPagerContent);

            // 1. ViewPager2에 어댑터 연결 (단 한 번)
            SearchPagerAdapter pagerAdapter = new SearchPagerAdapter(fragmentActivity);
